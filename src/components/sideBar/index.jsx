        ...
        <Style>
            ...
            <Link to='/'>
                ...
                <div     className="d-flex align-items-center  pl-3  text-muted mb-3 ">
                    ...
                    <div onClick={()=>setSchedule(!schedule)}  className="d-flex justify-content-between w-100 video">
                        {" "}
                        <h6 className="mb-0 text-nowrap">Schedule </h6>
                        {!schedule ? <MdKeyboardArrowUp/>: <MdKeyboardArrowDown/>}
                    </div>
                  
                </div>
                {schedule && <>
                    <div className="text-start ps-4 ps-lg-5 mb-4"> 
                    <Link className="text-black text-muted " to={'/reports'}><h6>Schedule Report </h6></Link></div>

                     <div className="text-start ps-4 ps-lg-5 mb-4"> 
                    <Link className="text-black text-muted " to={'/Visit-Targets'}><h6>Visit targets </h6></Link></div>
                ...
                <div     className="d-flex align-items-center  pl-3  text-muted mb-3 ">
                    ...
                    <div onClick={()=>setAdmin(!admin)}  className="d-flex justify-content-between w-100 video">
                        {" "}
                        <h6 className="mb-0 text-nowrap">Admin Console </h6>
                        {!admin ? <MdKeyboardArrowUp/>: <MdKeyboardArrowDown/>}
                    </div>
                  
                </div>
                {admin && <>
                    <div className="text-start ps-4 ps-lg-5 mb-4"> 
                    <Link className="text-black text-muted " to={'/admin/setting'}><h6>Field Rep </h6></Link></div>
               <div className="text-start ps-4 ps-lg-5 mb-4"> 
