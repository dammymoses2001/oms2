...
export const OrderModal =({show,orderData,setShow,ProductColumn,setDeclineModal,supplierDetail,AcceptOrderFunc}) =>{
                    ...
                    <div>
                       ...
                       <div className="mb-3 px-3 "> 
                            <CSVLink
                                 ...
                                 filename={"Order List"} 
                                data={handleProductData(orderData)} headers={headers}>
...
export const OrderProductModal =({declineModal,setDeclineModal,setRejectReason,setShow,RejectOrderFunc,supplierDetail,rejectReason})=>{
    return(
        <ModalComp
        show={declineModal}
                    ...
                    <div>
                        <div className="text-end">
                            ...
                            <button
                                ...
                                onClick={() => {
                                    RejectOrderFunc(
                                        supplierDetail?._id ,{  "reasonDeclined": rejectReason
                                    }
                                    );
                                }}
                            >
